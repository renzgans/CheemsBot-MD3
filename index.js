...
console.log(color('\n🐶 YT CHANNEL: Renz GTPS ','silver'))
console.log(color('🐶 GITHUB: renzgans ','silver'))
console.log(color('🐶 WA NUMBER: +6281250365581 ','silver'))
console.log(color('  🦄Renz Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6281250365581'))
    console.log(color('🐶', 'cyan'), color('Renz Bot Is Online...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using Renz Bot', 'white'))
    let { version, isLatest } = await fetchLatestBaileysVersion()
    const XeonBotInc = XeonBotIncConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['Subscribe Renz'],
        auth: state,
        version
    })
